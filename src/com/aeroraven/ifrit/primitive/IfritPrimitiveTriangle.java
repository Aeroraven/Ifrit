...
extends IfritPrimitiveBase{
	...
	public IfritPrimitiveTriangle() {
		...
		this.isFinal=true;
		this.renderMode=IfritRenderMode.TRIANGLE;
	}
	public IfritPrimitiveTriangle(double x1,double y1,double x2,double y2,double x3,double y3) {
		pointlist = new ArrayList<IfritVectord>();
		pointlist.add(new IfritVectord(x1,y1));
		pointlist.add(new IfritVectord(x2,y2));
		pointlist.add(new IfritVectord(x3,y3));
