...
public final class IfritCPAddRenderEventHandler
extends IfritCommandBase{
	public IfritCPAddRenderEventHandler(Object ...objects) {
		super(objects);
	}
	@Override
	...
	public void execute(Object... objects) {
		if(objects[0] instanceof IfritThreadMediator) {
			...
			renderThread.addEventHandler((String)paramList.get(0), (IfritEventHandler)paramList.get(1));
		}
	}
	@Override
	public void undo() {
